...
#SBATCH --job-name=shotgunR				# Job name
#SBATCH --output=shotgunR.%j.out		# Name of stdout output file (%j expands to %jobId)
#SBATCH --error=shotgunR.%j.err		# Name of stdout output file (%j expands to %jobId)

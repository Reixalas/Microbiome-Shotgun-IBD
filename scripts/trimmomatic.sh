...
#SBATCH --job-name=trimmo_ruben				# Job name
#SBATCH --output=trimmo_ruben.%j.out		# Name of stdout output file (%j expands to %jobId)
#SBATCH --error=trimmo_ruben.%j.err		# Name of stdout output file (%j expands to %jobId)

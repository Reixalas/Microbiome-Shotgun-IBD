...
#SBATCH --output=trimmomatic.%j.out		# Name of stdout output file (%j expands to %jobId)
#SBATCH --error=trimmomatic.%j.err		# Name of stdout output file (%j expands to %jobId)
